...
if(isset($_GET["id"])){
    $hero = $db->query('SELECT name,last_name,occupation,wilaya,birthdate,arrested_date,court,released_date,reason,sentence,comment 
    FROM heroes 
    WHERE id = ?', $_GET["id"]
    )->fetchArray();
}
              ...
              <form action="#">
                ...
                <div class="row form-group">
                  <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <input type="text" id="fname" class="form-control" value="<?php echo $hero["name"]; ?>" required>
                  </div>
                  <div class="col-md-6">
                    <label class="text-black" for="lname">Last Name *</label>
                    <input type="text" id="lname" class="form-control" value="<?php echo $hero["last_name"]; ?>"  required>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="occupation" class="form-control" value="<?php echo $hero["occupation"]; ?>" >
                  </div>
                  <div class="col-md-6">
                    <label class="text-black" for="wilaya">Wilaya *</label>
                    <input type="text" id="wilaya" class="form-control"  value="<?php echo $hero["wilaya"]; ?>" required>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <input type="date" id="birthdate" class="form-control"  value="<?php echo $hero["birthdate"]; ?>" >
                  </div>
                  <div class="col-md-6 mb-3 mb-md-0">
                ...
                <div class="row form-group">
                  ...
                  <label class="text-black" for="court">Court</label> 
                    <input type="text" id="court" class="form-control" value="<?php echo $hero["court"]; ?>" >
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" id="charges" class="form-control" value="<?php echo $hero["reason"]; ?>" >
                  </div>
                </div>
                ...
                <div class="row form-group">
                  ...
                  <label class="text-black" for="sentence">Sentence</label>
                    <input type="text" id="sentence" class="form-control" value="<?php echo $hero["sentence"]; ?>" >
                  </div>
                </div>
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    ...
                    <textarea name="message" id="comments" cols="30" rows="7" class="form-control" placeholder="Any comments here"><?php echo $hero["comment"];?></textarea>
                  </div>
                </div>

                <div class="row form-group">
                  <div class="col-md-12">
                    <input type="submit" value="Validate" class="btn btn-primary py-2 px-4 text-white">
                  </div>
                </div>
              </form>
            </div>
